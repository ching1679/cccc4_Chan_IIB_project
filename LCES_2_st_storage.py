...
co2_2c = polytrope(co2_1c, 20*co2_1c.p, 0.9, 'c')
co2_3c = HX(co2_2c, ThermOil, 0.95, 0.01, 'c')
co2_3cc = ex_hx(co2_3c.wflout, T0, 0.01, 'c')
co2_4c = polytrope(co2_3cc.state2, 20*co2_3c.wflout.p, 0.9, 'c')
co2_5ca = HX(co2_4c, HT_ThermOil, 0.95, 0.01, 'c')
co2_5cb = HX(co2_5ca.wflout, ThermOil, 0.95, 0.01, 'c')

N_5c = ST('pT', (1 + 0.01)*P0, 220, 'Initial PTES', N)
co2_6c = coupler(co2_5cb.wflout, N_5c, 0.95, 0.01, 'c')
co2_7c = cryotb_test(co2_6c.LCESout, 0.9, 'c')

N_1c = coupler(co2_5cb.wflout, N_5c, 0.95, 0.01, 'c')
N_2c = polytrope(N_1c.PTESout, 6*N_1c.PTESout.p, 0.9, 'c')
N_3c = HX(N_2c, ThermOil, 0.95, 0.01, 'c')
N_4c = polytrope(N_3c.wflout, N_1c.PTESout.p*(1 + 0.01)**2, 0.9, 'c')
N_5c = ex_hx(N_4c.state2, 220, 0.01, 'c')
...
co2_4db = HX(co2_5d.LCESout, co2_5cb.stflout, 0.95, 0.01, 'd')
co2_4da = HX(co2_4db.wflout, co2_5ca.stflout, 0.95, 0.01, 'd')
co2_3d = polytrope(co2_4da.wflout, co2_2c.state2.p, 0.9, 'd')
co2_2d = HX(co2_3d.state2, co2_3c.stflout, 0.95, 0.01, 'd')
