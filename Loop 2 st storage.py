...
cyc_input.LCES_ov_pr = 225
cyc_input.PTES_ov_pr = 6
...
LCES_h_eff = np.array([])
LCES_b_eff = np.array([])
LCES_b_vden = np.array([])
PTES_h_eff = np.array([])
PTES_b_eff = np.array([])
PTES_b_vden = np.array([])
CC_h_eff = np.array([])
CC_b_eff = np.array([])
CC_b_vden = np.array([])
...
for i in range(loop_prm.p2_ln):
    ...
    for j in range(loop_prm.p1_pt):
            ...
            co2_5cb = HX(co2_5ca.wflout, ThermOil, cyc_input.hx_eff, cyc_input.hx_dp, 'c')
            co2_6c = coupler(co2_5cb.wflout, N_5c, cyc_input.hx_eff, cyc_input.hx_dp, 'c')
            co2_7c = cryotb_test(co2_6c.LCESout, cyc_input.wx_eff, 'c')

            N_6c = coupler(co2_5cb.wflout, N_5c, cyc_input.hx_eff, cyc_input.hx_dp, 'c')
            N_6cc = ex_hx(N_6c.PTESout, T0, cyc_input.hx_dp, 'c')
            ...
            co2_4db = HX(co2_5d.LCESout, co2_5cb.stflout, cyc_input.hx_eff, cyc_input.hx_dp, 'd')
            co2_4da = HX(co2_4db.wflout, co2_5ca.stflout, cyc_input.hx_eff, cyc_input.hx_dp, 'd')
            ...
            co2_list = [co2_1c, co2_2c, co2_3c, co2_3cc, co2_4c, co2_5ca, co2_5cb, co2_6c, co2_7c, co2_6d, co2_5d, co2_4db, co2_4da, co2_3d, co2_2d, co2_1d, co2_1]
            N_list = [N_1c, N_2c, N_3c, N_4c, N_5c, N_6c, N_6cc, N_2d, N_1d, N_5d, N_3d, N_3dd]
